...
pauza = 0.5;        % gIntervalval na vykreslovanie
...
int_pri_aut = [0 0 0 0 0 0]; % Intervalval prichodu aut (meni sa podla cyklu)
...
% fuzzy()
f = readfis('Fuzzy_krizovatkaTrimf');
% surfview(readfis('Fuzzy_krizovatkaTrimf'))
% surfview(f)
